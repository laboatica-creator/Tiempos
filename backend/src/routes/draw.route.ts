...
import { createDraw, setWinningNumber, getDraws, cancelDraw, getSuggestedResults } from '../controllers/draw.controller';
...
// Admin-only routes
router.get('/suggestions', authenticateJWT, requirePermission('draws'), getSuggestedResults);
